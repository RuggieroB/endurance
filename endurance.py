...
Algoritmo "endurance.py": Algoritmo che dati in input la quantità di carburante (in galloni) di un aeroplano e il consumo orario (in galloni/h), 
determina la durata massima di volo.
'''
